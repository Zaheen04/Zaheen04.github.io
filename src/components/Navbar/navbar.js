...
import "./navbar.css"
import resume from "../../assets/Zaheen-Khan-Resume"
            ...
            <div id='nav-menu'>
                ...
                <div id="largeScreenNavbar">
                    ...
                    <div>
                        ...
                        <a href="https://github.com/Zaheen04" target="_blank" className="nav-link github">
                            GitHub
                        </a>
                    </div>
                </div>
            ...
            </div >
            {
                burger ? (<div id='smallScreenDropDown' >
                    <div>
                        ...
                        <a href="https://github.com/Zaheen04" target="_blank" className="nav-link github" style={{ margin: "auto", width: "100px" }}
